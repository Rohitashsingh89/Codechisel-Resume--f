  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Subscribe to get updates on new coding problems, feature releases, and
        exclusive insights from the Code Chisel community — straight to your
        inbox.
      </p>
      <div>
        <input
        ...
        <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
          No spam. Just updates that matter to you as a developer.
        </p>
      </div>
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "var(--color-primary)" : "var(--color-primary)"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
