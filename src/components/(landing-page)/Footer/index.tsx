  ...
  return (
    <>
      <footer className="dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24">
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="text-body-color dark:text-body-color-dark mb-9 text-base leading-relaxed">
                  Helping you solve problems with clear explanations and daily
                  practice.
                </p>
                <div className="flex items-center">
                  <a
          ...
          <div className="py-8">
            <p className="text-body-color text-center text-base dark:text-white">
              Copyright Code Chisel. Powered by{" "}
              <Link
                href="https://www.zenithx.in"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="absolute top-14 right-0 z-[-1] opacity-[0.6]">
          <svg
            width="160"
            height="160"
            viewBox="0 0 160 160"
          ...
          >
            <defs>
              <radialGradient
                ...
                gradientTransform="translate(80 80) scale(80)"
              >
                <stop offset="0%" stopColor="var(--color-primary)" stopOpacity="0.45" />
                <stop offset="55%" stopColor="var(--color-primary)" stopOpacity="0.25" />
            ...
            <circle cx="80" cy="80" r="80" fill="url(#cc-pulse-fill)" />
            <circle
              cx="80"
              cy="80"
              r="64"
              fill="none"
              stroke="url(#cc-pulse-ring)"
              strokeWidth="1.5"
            ...
            <circle
              ...
              vectorEffect="non-scaling-stroke"
            />
            <circle cx="80" cy="80" r="3" fill="var(--color-primary)" opacity="0.9" />
          </svg>
        </div>
          ...
          >
            <defs>
              ...
              <radialGradient
                ...
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(180 80) scale(200)"
              >
                <stop offset="60%" stopColor="white" stopOpacity="1" />
                <stop offset="100%" stopColor="white" stopOpacity="0" />
              </radialGradient>
              <mask id="cc-wave-mask">
                <rect width="360" height="160" fill="url(#cc-wave-fade)" />
              </mask>
            </defs>
            <g
              mask="url(#cc-wave-mask)"
              stroke="url(#cc-wave-stroke)"
              fill="none"
              strokeWidth="1.2"
              vectorEffect="non-scaling-stroke"
            >
              <path
                d="M0 40 C60 10 120 70 180 40 S300 10 360 40"
                strokeOpacity="0.65"
              />
              <path
                d="M0 70 C60 40 120 100 180 70 S300 40 360 70"
                strokeOpacity="0.5"
              />
              <path
                d="M0 100 C60 70 120 130 180 100 S300 70 360 100"
                strokeOpacity="0.4"
              />
              <path
                d="M0 130 C60 100 120 160 180 130 S300 100 360 130"
                strokeOpacity="0.3"
              />
            </g>
          </svg>
