...
// const PDFSplitHeading = ({ text, left }: { text: string; left: string, right: string }) => (
//     <View style={{ marginBottom: 6, borderBottomWidth: 1, borderBottomColor: left }}>
//       <Text style={{ fontSize: 12, fontWeight: 700, color: left }}>{text}</Text>
//     </View>
//   );

export function ResumePDF({ data, accent }: ResumePDFProps) {
